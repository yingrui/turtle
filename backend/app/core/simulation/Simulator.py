...
from app.core.engine.RiskController import RiskController
from app.core.engine.TradeSignalMonitor import TradeSignalMonitor
...
class Simulator:
    ...
    def __init__(
        ...
        self._logger = logger_sink or InvestmentLogger(portfolio.name, folder=logs_folder)
        ...
        self._increase_investments = increase_investments or []

    @property
    def logger(self) -> InvestmentLogger:
        return self._logger
